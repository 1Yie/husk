...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      cn(
      "flex cursor-default select-none items-center rounded-lg px-2 py-1.5 text-sm outline-none focus:bg-neutral-100",
      SURFACE_OVERLAY_FOCUS,
      SURFACE_OVERLAY_OPEN,
    ),
      inset && "pl-8",
...
>(({ className, ...props }, ref) => {
  ...
  <DropdownMenuPrimitive.SubContent
    ref={setRef}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden p-1 text-neutral-900 shadow-popup duration-100 ease-out data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-1 data-[side=left]:slide-in-from-right-1 data-[side=right]:slide-in-from-left-1 data-[side=top]:slide-in-from-bottom-1",
      SURFACE_OVERLAY,
      !placed && "invisible",
      className
    )}
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-lg py-1.5 pl-8 pr-2 text-sm outline-none transition-colors  focus:text-neutral-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      SURFACE_OVERLAY_FOCUS,
      className
    )}
    checked={checked}
